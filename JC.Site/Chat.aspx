<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Chat.aspx.cs" Inherits="JC.Site.Chat" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Jobsity Chat : Chat Page</title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            window.onfocus = function (event) {
                if (event.explicitOriginalTarget === window) {
                    ...
                    document.title = 'Jobsity Chat App';
                }
            }
        ...
        function registerClientMethods(chatHub) {
            ...
            chatHub.client.messageReceived = function (userName, message, time, userimg) {
                ...
                if (CurrUser1 !== userName) {
                    ...
                    IntervalVal = setInterval("ShowTitleAlert('Jobsity Chat App', '" + Notification + "')", 800);
                }
            }
        ...
        function RemoveOlderMessages() {
            var maxAllowed = 5;
            var total = $('#divChatWindow .direct-chat-msg').length;

            var count = total - maxAllowed;

            for (var i = 0; i < count; i++) {
                $('#divChatWindow .direct-chat-msg').eq(0).remove();
            }
        }
        ...
        <div class="content-wrapper">
            ...
            <header class="main-header" style="background: #bedaeb">
                ...
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>Jobsity</b> Chat App</span>
                </a>
        ...
        <div class="modal fade" id="ShowPictureModal" role="dialog">
            <div class="modal-dialog" style="width: 100%; max-width: 750px; min-width: 350px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <img id="ImgModal" src="Uploads/Chrysanthemum.jpg" class="user-image" style="max-width: 700px; min-width: 300px" alt="" />
                        </div>
                    </div>
                </div>
            </div>
