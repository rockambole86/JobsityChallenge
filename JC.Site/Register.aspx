<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="JC.Site.Register" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Jobsity Chat : Register</title>
...
<form id="form1" runat="server">
    ...
    <div class="register-box">
        <div class="register-logo">
            <a href="Login.aspx"><b>Jobsity </b>Chat App</a>
        </div>
